...
\renewcommand*\cftlistingspresnum{Quelltext~}
...
\renewcommand\lstlistlistingname{Quelltextverzeichnis} %Listingverzeichnis}
\renewcommand\lstlistingname{Quelltext} %Listingverzeichnis}
